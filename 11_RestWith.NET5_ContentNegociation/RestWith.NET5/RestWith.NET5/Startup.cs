...
namespace RestWith.NET5
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Faz com que a aplicação suporte XML e JSON, é preciso incluir o pacote Microsoft.AspNetCore.Mvc.Formatters.Xml
            services.AddMvc(options =>
            {
                // Aceita a propriedade que vem setada no cabeçalho da request (isso é para funcionar no Postman)
                // https://prnt.sc/107o24h
